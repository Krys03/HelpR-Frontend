...
import { Form, TextareaField} from 'react-components-form'
import { connectBack } from './../../tools/axiosURL'
import { connect } from 'react-redux'
import { setModal, submitMessage, updateRequest } from './../../tools/actions'
import { Button, Icon, Form as FormSemantic , Comment} from 'semantic-ui-react'
    ...
    <div> 
      ...
      >
        ...
        <div id="submit" className="text-center">
          <Button className="btn btn-primary" value="Send Message" color='blue' ><Icon name='edit' />Send</Button>
        </div>
      </Form>
    </div>
    </FormSemantic>
