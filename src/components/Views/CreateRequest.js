...
import { Form, TextField, TextareaField, SelectField } from 'react-components-form'
import Script from 'react-load-script';
import { withRouter } from 'react-router-dom'
import { Icon, Header, Button , Form as FormSemantic} from 'semantic-ui-react'
...
const CreateRequest = (props) => {
	...
	return(
		<div>
		<Script attributes={{ id: 'google'}} url="https://maps.googleapis.com/maps/api/js?key=AIzaSyAET8cJJmx6ItXOHjFgeupu5u5TVe5ZkX4&libraries=places"/>
			<div className="container">
			
				<div className="row">
					<div className="col-12 text-center">
						<Header as='h1' style={{ marginTop : 120 , marginBottom : 50 }} color='blue'><Icon name='plus circle' />Submit your Request for help</Header>
					</div>
					...
					<FormSemantic>
						...
						>
							...
							<div id="submit" className="text-center">
								<Button content='Submit' color='blue'  type="Submit" fluid />
							</div>
						</Form>
					</FormSemantic>
					</div>
